...
* [Latency vs throughput](#latency-vs-throughput)(延迟和吞吐)
* [Availability vs consistency](#availability-vs-consistency)(可用性和一致性)
    * [CAP theorem](#cap-theorem)
        * [CP - consistency and partition tolerance](#cp---consistency-and-partition-tolerance)(分区容忍性)
        * [AP - availability and partition tolerance](#ap---availability-and-partition-tolerance)
* [Consistency patterns](#consistency-patterns)(一致性)
    * [Weak consistency](#weak-consistency)
    * [Eventual consistency](#eventual-consistency)(结果一致)
    * [Strong consistency](#strong-consistency)
* [Availability patterns](#availability-patterns)
    * [Fail-over](#fail-over)
    * [Replication](#replication)(备份)
* [Domain name system](#domain-name-system)
* [Content delivery network](#content-delivery-network)
    * [Push CDNs](#push-cdns)
    * [Pull CDNs](#pull-cdns)
* [Load balancer](#load-balancer)
    * [Active-passive](#active-passive)(主被模式)
    * [Active-active](#active-active)
    * [Layer 4 load balancing](#layer-4-load-balancing)
    * [Layer 7 load balancing](#layer-7-load-balancing)
    * [Horizontal scaling](#horizontal-scaling)(水平扩展)
...
* [Database](#database)
    * [Relational database management system (RDBMS)](#relational-database-management-system-rdbms)
        ...
        * [Federation](#federation)(联合)
        * [Sharding](#sharding)(分片)
        * [Denormalization](#denormalization)(反范式)
        * [SQL tuning](#sql-tuning)(微调)
    * [NoSQL](#nosql)
...
* [Communication](#communication)
    ...
    * [Representational state transfer (REST)](#representational-state-transfer-rest)(抽像)
* [Security](#security)
